...
* **Build (MSYS2 MinGW-w64)**: `pacman -S mingw-w64-x86_64-gcc mingw-w64-x86_64-glib2 make`, rồi `make -f Makefile.win`. Đóng bộ cài (cần Inno Setup): `make -f Makefile.win setup VERSION=0.5.3` (version phải là `X.Y.Z`, khớp `windows/version.h`).
