...
int main(int argc, char **argv) {
    ...
    if(!g_str_has_suffix(url,"/api/generate") || (strcmp(timeout,"1.5") && strcmp(timeout,"120"))) return 2;
    ...
    gboolean valid=strstr(body->str,"\"stream\":false") && strstr(body->str,"a\\\"b") && strstr(body->str,"qwen2:0.5b");
